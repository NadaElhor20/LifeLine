...
const { mailRegex,passwordRegex, landPhoneRegex, govPattern, cityPattern } = require('../config');
...
const validateRegisteredHospital = async (req, res, next) => {
  try {
...
const validateUpdatedHospital = async (req, res, next) => {
  try {
...
module.exports = {
  validateRegisteredHospital,
  validateUpdatedHospital,
};
